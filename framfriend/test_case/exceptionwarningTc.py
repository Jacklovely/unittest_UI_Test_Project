'''
Code description：合同异常预警取消模块 testcase
Create time：
Developer：
'''
import time
...
class DetailAccount_Tc(MyunitTest):
    ...
    def test_alone_query_1_1(self):
        """正确合同号查询"""
        menu = Exceptionwarning_page(self.driver)  # 实例化合同异常预警取消页面
        self.login.loginFunc()  # 登录
        menu.inexceptionwarning_page() # 进入合同异常预警取消页面
        time.sleep(3)
    ...
    def test_alone_query_1_2(self):
        """错误合同号查询"""
        menu = Exceptionwarning_page(self.driver)  # 实例化合同期异常预警取消页面
        self.login.loginFunc()  # 登录
        menu.inexceptionwarning_page()  # 进入合同异常预警取消页面
        time.sleep(3)
        menu.cBtn(menu.button_list[0])
    ...
    def test_alone_query_1_3(self):
        """正确合同名称查询"""
        menu = Exceptionwarning_page(self.driver)  # 实例化合同异常取消页面
        self.login.loginFunc()  # 登录
        menu.inexceptionwarning_page()  # 进入合同异常预警取消页面
        time.sleep(3)
        menu.cBtn(menu.button_list[0])
    ...
    #     """签订时间查询"""
    #     menu = Termwarning_page(self.driver)  # 实例化合同异常预警取消页面
    #     self.login.loginFunc()  # 登录
    #     menu.intermwarning()  # 进入合同异常预警取消页面
    #     time.sleep(3)
    #     menu.cBtn(menu.button_list[0])
